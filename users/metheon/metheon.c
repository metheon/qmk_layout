...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    //  |--------------------------------------------|                    |--------------------------------------------|
         UNDO    ,CUT     ,COPY    ,PASTE   ,__NONE__                     ,GUI_OFF ,GUI_ON  ,KC_LGUI ,__NONE__,__NONE__,
    //  '-------------------------+--------+---------+--------+  +--------+--------+--------+--------------------------'
                                   _______ ,_______  ,_______    ,_______ ,_______ ,_______ ,
    //                            '--------+---------+--------+  +--------+--------+--------'
    //  Encoders
    ...
    //  |--------------------------------------------|                    |--------------------------------------------|
         UNDO    ,CUT     ,COPY    ,PASTE   ,__NONE__                     ,CG_TOGG ,KC_LCTL ,KC_LGUI ,WIN_MAC ,__NONE__,
    //  '-------------------------+--------+---------+--------+  +--------+--------+--------+--------------------------'
                                   __NONE__ ,KC_BTN1  ,KC_BTN2    ,_______ ,_______ ,_______ ,
    //                            '--------+---------+--------+  +--------+--------+--------'
    //  Encoders
    //  .--------+-------.
         MSE_E01 ,MSE_E02
