...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    //  |--------------------------------------------|                    |--------------------------------------------|
         KC_UNDS ,KC_MINS ,KC_LBRC ,KC_SCLN ,KC_COLN                      ,KC_RBRC ,__NONE__,__NONE__,KC_PERC ,KC_BSLS ,
    //  '-------------------------+--------+---------+--------+  +--------+--------+--------+--------------------------'
                                   SYM_E01 ,ESC_EXT  ,________   ,________,________,SYM_E02
    //                            '--------+---------+--------+  +--------+--------+--------'
    ),
    ...
    //  |--------------------------------------------|                    |--------------------------------------------|
         UNDO    ,CUT     ,COPY    ,PASTE   ,PASTE                        ,GUI_OFF ,GUI_ON  ,KC_LGUI ,__NONE__,__NONE__,
    //  '--------+--------+--------+--------+--------+--------+  +--------+--------+--------+--------+--------+--------'
                                   EXT_E01  ,________ ,________   ,STAB_FUN,TAB_SYM ,EXT_E02
    //                            '--------+---------+--------+  +--------+--------+--------'
    ),
    [_FUNPAD] = LAYOUT_metheon(
    //  .--------------------------------------------.                    .--------------------------------------------.
         KC_RPRN ,KC_F9   ,KC_F10  ,KC_F11  ,KC_F12                       ,__NONE__,__NONE__,__NONE__,__NONE__,__NONE__,
    //  |--------------------------------------------|                    |--------------------------------------------|
         KC_ENTER,KC_F5   ,KC_F6   ,KC_F7   ,KC_F8                        ,__NONE__,KC_LGUI ,KC_LSFT ,KC_LALT ,KC_LCTL ,
    //  |--------------------------------------------|                    |--------------------------------------------|
         KC_LPRN ,KC_F1   ,KC_F2   ,KC_F3   ,KC_F4                        ,__NONE__,__NONE__,__NONE__,__NONE__,__NONE__,
    //  '-------------------------+--------+---------+--------+  +--------+--------+--------+--------------------------'
    ...
    //  '-------------------------+--------+---------+--------+  +--------+--------+--------+--------------------------'
                                   ADJ_E01 ,RESET    ,________   ,________,RESET   ,ADJ_E02
    //                            '--------+---------+--------+  +--------+--------+--------'
    ),
