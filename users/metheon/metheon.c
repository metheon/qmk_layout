...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    //  '--------+--------+--------+--------+--------|   |--------+--------+--------+--------+--------'
                           BSE_E01 ,LOWER   ,SPC_EXT ,    SHIFT   ,RAISE   ,BSE_E02
    //                    '--------+--------+--------'   '--------+--------+--------'
    ),
    ...
    //  |--------+--------+--------+--------+--------|   |--------+--------+--------+--------+--------'
                           LWR_E01 ,________,__NONE__,    KC_0    ,________,LWR_E02
    //                    '--------+--------+--------'   '--------+--------+--------'
    ),
    ...
    //  .--------+--------+--------+--------+--------.   .--------+--------+--------+--------+--------.
         RESET   ,__NONE__,__NONE__,__NONE__,__NONE__,    __NONE__,__NONE__,__NONE__,__NONE__,__NONE__,
    //  |--------+--------+--------+--------+--------|   |--------+--------+--------+--------+--------|
    ...
    //  |--------+--------+--------+--------+--------|   |--------+--------+--------+--------+--------|
                           __NONE__,________,M_FSCRN ,    ________,________,__NONE__
    //                    '--------+--------+--------'   '--------+--------+--------'
    )
};
// clang-format on
