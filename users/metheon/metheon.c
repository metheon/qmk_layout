...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_BL3_BSE] = LAYOUT_metheon(
        KC_TAB  ,KC_TAB  ,KC_Q    ,KC_W    ,KC_E    ,KC_R    ,XXXXXXX ,XXXXXXX ,XXXXXXX ,XXXXXXX ,XXXXXXX ,XXXXXXX ,
        KC_ESC  ,KC_LSFT ,KC_A    ,KC_S    ,KC_D    ,KC_F    ,XXXXXXX ,XXXXXXX ,XXXXXXX ,XXXXXXX ,XXXXXXX ,XXXXXXX ,
        TO_BASE ,KC_LCTL ,KC_1    ,KC_2    ,KC_3    ,KC_4    ,XXXXXXX ,XXXXXXX ,XXXXXXX ,XXXXXXX ,XXXXXXX ,XXXXXXX ,
        XXXXXXX ,XXXXXXX ,KC_LALT ,KC_G    ,KC_V    ,BL3_SPC ,BL3_SPC ,XXXXXXX ,XXXXXXX ,XXXXXXX ,XXXXXXX ,XXXXXXX ,
        BL3_BSE_E01 ,BL3_BSE_E02
    ),
    [_BL3_UPR] = LAYOUT_metheon(
        _______ ,_______ ,KC_LBRC ,_______ ,KC_RBRC ,KC_C    ,XXXXXXX ,XXXXXXX ,XXXXXXX ,XXXXXXX ,XXXXXXX ,XXXXXXX ,
        _______ ,_______ ,_______ ,_______ ,_______ ,KC_X    ,XXXXXXX ,XXXXXXX ,XXXXXXX ,XXXXXXX ,XXXXXXX ,XXXXXXX ,
