...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_ADJUST] = LAYOUT_metheon(
        ...
        HIBRNT  ,RGB_VAI ,RGB_SAI ,RGB_HUI ,RGB_MOD ,RGB_TOG ,TO_BL3  ,KC_MPRV ,KC_MPLY ,KC_MNXT ,XXXXXXX ,XXXXXXX ,
        SLEEP   ,RGB_VAD ,RGB_SAD ,RGB_HUD ,RGB_RMOD,XXXXXXX ,XXXXXXX ,KC_MUTE ,KC_VOLD ,KC_VOLU ,XXXXXXX ,XXXXXXX ,
    ...
    [_BL3_BSE] = LAYOUT_metheon(
        ...
        XXXXXXX ,KC_ESC  ,KC_A    ,KC_S    ,KC_D    ,KC_F    ,XXXXXXX ,TO_BASE ,XXXXXXX ,XXXXXXX ,XXXXXXX ,XXXXXXX ,
        XXXXXXX ,KC_LSFT ,KC_Z    ,KC_X    ,KC_C    ,XXXXXXX ,XXXXXXX ,XXXXXXX ,XXXXXXX ,XXXXXXX ,XXXXXXX ,XXXXXXX ,
        XXXXXXX ,XXXXXXX ,XXXXXXX ,KC_G    ,KC_V    ,BL3_SPC ,BL3_SPC ,XXXXXXX ,XXXXXXX ,XXXXXXX ,XXXXXXX ,XXXXXXX ,
