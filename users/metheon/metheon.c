...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BASE] = LAYOUT_metheon(
        ...
        KC_LEAD ,LOCK_PC ,ALT_GUI ,TD_CTRL ,LWR_DEL ,SPACE_FN,ENTER_FN,RSE_BSP ,TD_CTRL ,GUI_ALT ,DM_PLY1 ,DM_PLY2 ,
        BSE_E01 ,BSE_E02
    ),
    ...
    [_EXTEND] = LAYOUT_metheon(
        SPACES  ,XXXXXXX ,XXXXXXX ,LEFT_SPC,RGHT_SPC,XXXXXXX ,KC_PGUP ,KC_HOME ,KC_UP   ,KC_END  ,XXXXXXX ,DEL_WRD ,
