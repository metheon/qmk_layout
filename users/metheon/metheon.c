...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    //  '--------+--------+--------+--------+--------+--------+--------+--------| |--------+--------+--------+--------+--------+--------+--------+--------'
                                    LWR_E01 ,__NONE__,__NONE__,OSM_SFT ,________,  ________,OSM_SFT ,__NONE__,__NONE__,LWR_E02
    //                             '--------+--------+--------+--------+--------' '--------+--------+--------+--------+--------'
    ),
    ...
    //  '--------+--------+--------+--------+--------+--------+--------+--------| |--------+--------+--------+--------+--------+--------+--------+--------'
                                    RSE_E01 ,__NONE__,__NONE__,SPC_EXT ,________,  ________,SPC_EXT ,__NONE__,__NONE__,RSE_E02
    //                             '--------+--------+--------+--------+--------' '--------+--------+--------+--------+--------'
    ),
