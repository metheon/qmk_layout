...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    //  '--------+--------+--------+--------+--------| |--------+--------+--------+--------+--------'
                           LWR_E01 ,OSM_SFT ,________,  ________,OSM_SFT ,LWR_E02
    //                    '--------+--------+--------' '--------+--------+--------'
    ),
    ...
    //  '--------+--------+--------+--------+--------| |--------+--------+--------+--------+--------'
                           RSE_E01 ,SPC_EXT ,________,  ________,SPC_EXT ,RSE_E02
    //                    '--------+--------+--------' '--------+--------+--------'
    ),
    ...
    //  |--------+--------+--------+--------+--------. .--------+--------+--------+--------+--------|
         __NONE__,__NONE__,KC_STAB ,KC_TAB  ,LOCK    ,  __NONE__,KC_BSPC ,KC_DEL  ,__NONE__,__NONE__,
    //  '--------+--------+--------+--------+--------| |--------+--------+--------+--------+--------'
