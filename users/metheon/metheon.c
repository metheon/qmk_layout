...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    //  .--------------------------------------------.                    .--------------------------------------------.
         DK_RPRN ,KC_9    ,KC_F8   ,KC_7    ,KC_F12                       ,DK_ASTR ,DK_7    ,DK_8    ,DK_9    ,DK_SLSH ,
    //  |--------------------------------------------|                    |--------------------------------------------|
         HOME_ENT,HOME_F6 ,HOME_F5,HOME_F4  ,KC_F11                       ,DK_PLUS ,HOME_4  ,HOME_5  ,HOME_6  ,HOME_MN ,
    //  |--------------------------------------------|                    |--------------------------------------------|
         DK_LPRN ,KC_F3   ,KC_F2   ,KC_F1   ,KC_F10                       ,DK_0    ,DK_1    ,DK_2    ,DK_3    ,DK_EQL  ,
    //  '-------------------------+--------+---------+--------+  +--------+--------+--------+--------------------------'
